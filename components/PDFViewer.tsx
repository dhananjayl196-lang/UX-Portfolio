  ...
  return (
    <div className="w-full rounded-[4px] overflow-hidden border border-black/10 bg-paper-2">
      ...
      <div className="flex items-center justify-between px-5 py-3 border-b border-black/[.08] bg-paper-2">
        <span className="font-body text-[12px] text-ink-3 tracking-[.06em] uppercase">
          {title}
        </span>
          ...
          className="font-body text-[11px] text-accent tracking-[.06em] uppercase no-underline hover:underline flex items-center gap-1.5"
        >
          ↗ Open full screen
        </a>
      </div>
      ...
      {/* Iframe — full width, tall enough to read */}
      <iframe
        src={src}
        title={title}
        style={{
      ...
      <div className="flex items-center justify-between px-5 py-3 border-t border-black/[.08] bg-paper-2">
        <span className="font-body text-[12px] text-ink-3">
          Scroll to read the full case study
        </span>
